      ...
      <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div
              class="p-6 bg-white border-b border-gray-200 md:grid md:grid-cols-5 gap-4"
            >
              <div class="col-span-1">
                ...
                >
                  <ul class="space-y-2 left-menu">
                    ...
                    <li>
                      <form
                        class="cursor-pointer w-full inline-flex"
                        action="/logout"
                        method="post"
                      >
                        <svg
                        ...
                        <button
                          class="flex-1 ml-3 whitespace-nowrap text-left"
                          type="submit"
                        >
                          Log out
                        </button>
              ...
              <div class="col-span-4">
                <div class="flex justify-between mb-4">
                  ...
                  <a
                    href="/posts/create"
                    class="px-4 py-2 bg-yellow-600 rounded-sm text-white"
                    >Add Post</a
                  >
                </div>
                  ...
                  >
                    ...
                    <tbody>
                      ...
                      >
                        <td class="px-6 py-4">
                          <img
                            src="public/assets/thumbnails/800x400.png"
                            alt=""
                            class="w-16"
                          />
                        </td>
                        <td class="px-6 py-4">Exercitation</td>
                        <td class="px-6 py-4">
                          <br />
                          <b>Notice</b>: Undefined property: stdClass::$user_id
                          in
                        </td>
                      ...
                      >
                        ...
                        <td class="px-6 py-4">Mollitia tempor volu</td>
                        <td class="px-6 py-4">
                          <br />
                          <b>Notice</b>: Undefined property: stdClass::$user_id
                          in
